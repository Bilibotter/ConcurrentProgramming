 ...
 */
public class TestUpdateLock {
    private final static UpgradeReadWriteLock lock = new UpgradeReadWriteLock(false);

    private final static UpgradeReadWriteLock.ReadLock read = lock.readerLock();

    private final static UpgradeReadWriteLock.WriteLock write = lock.writerLock();
